...
合计: **7,506** 行代码（覆盖前 5 种语言、共 **45** 个文件）。
...
- **上游仓库**: <https://github.com/dlvhdr/diffnav>
- **许可证**: MIT
...
- **Star**: 1,561 · **Fork**: 47 · **开放 issue**: 59 · **贡献者**: 13

## 累计统计

- **发布数**: 21 · **已合并 PR**: 77 · **开放 PR**: 4 · **已关闭 issue**: 35 · **开放 issue**: 24 · **提交数**: 158

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-11 | 0 | 3 | 0 | 0 | 1 | 4 |
| last60d | 2026-07-12 | 1 | 4 | 1 | 2 | 2 | 8 |
| 90d | 2026-06-12 | 1 | 6 | 1 | 4 | 2 | 11 |
| last180d | 2026-03-14 | 2 | 23 | 3 | 10 | 8 | 36 |
| 360d | 2025-09-15 | 11 | 58 | 4 | 17 | 18 | 81 |
| last720d | 2024-09-20 | 21 | 77 | 4 | 30 | 23 | 146 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/diffnav.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260910.yml` · 2026-09-10T22:39:42Z._
